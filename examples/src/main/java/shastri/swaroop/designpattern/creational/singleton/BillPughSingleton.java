...
// in certain scenarios where too many threads try to get the instance of the Singleton class
// simultaneously. So Bill Pugh came up with a different approach to create the Singleton class using
// an inner static helper class. The Bill Pugh Singleton implementation goes like this;
